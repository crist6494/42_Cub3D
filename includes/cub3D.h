...
/*-----Minimap-----*/
void				init_minimap(t_game *game, t_minimap *minimap, int width,
						int height);
...
/*--------Movement--------------*/
void				player_advance(t_game *game, t_player *player,
						int direction);
void				rotate(t_game *game, t_player *player, int clockwise);
void				player_lateral(t_game *game, t_player *player,
						int direction);
...
/*---------Collisions_sides-------------*/
int					check_left_down_p(t_player *player, t_map *map,
						float advance_x, float advance_y);
int					check_right_down_p(t_player *player, t_map *map,
						float advance_x, float advance_y);
int					check_left_up_p(t_player *player, t_map *map,
						float advance_x, float advance_y);
int					check_right_up_p(t_player *player, t_map *map,
						float advance_x, float advance_y);
...
float				raycast(t_game *game, t_player *player, t_ray *ray,
						float angle);

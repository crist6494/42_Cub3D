...
/*   Updated: 2023/07/14 12:09:59 by cmorales         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_square(t_game *game, t_square *square, t_player *player)
{
	...
	insert_coord(square->p_square, player->square->p_center->x - player->tam
			/ 2,
					player->square->p_center->y - player->tam / 2);
					//Pintar el cuadrado en medio
...
static void	init_direction(t_player *player)
{
	...
	update_direction(player);              
		//Iniciamos la direcciona de la linea
